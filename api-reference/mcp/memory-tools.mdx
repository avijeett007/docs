...
Replace `<connect-hub>` with your integration gateway URL and `<customer_mcp_token>` with a valid customer MCP token (obtainable from the customer portal or the partner portal API Keys page).
