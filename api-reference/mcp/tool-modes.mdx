...
> 📷 **Screenshot needed:** _Add a screenshot of the "Create Token" modal in **AI Agents → MCP Tokens**._
...
- [MCP tokens](/partner-portal/settings/mcp-tokens) — Generate and manage partner MCP tokens. *Note: the live Partner Portal sidebar entry for MCP Tokens moved to a top-level AI PLATFORM link (URL `/partner/ai-agents/mcp/tokens`). The doc file remains at this URL for now — see [[knotie-doc-gaps|G43]] for the navigation drift.*
