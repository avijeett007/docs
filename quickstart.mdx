...
1. In the Partner Portal sidebar, go to **Settings → White-Label Portal** (live sidebar label; the doc page title is still "Whitelabel Settings").
...
4. Choose a portal mode — the Quick Onboard modal's default mode is **Basic** (live default; the doc's "Standard" terminology may be stale — confirm in the modal). SaaS mode is the alternative for productized offers.
...
1. Go to **Agent Analytics** in the sidebar (page header reads "AI Usage Analytics") to confirm data is flowing.
