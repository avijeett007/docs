...
![App Packages section — "New Package" button, package list, OpenClaw Auto-Deploy callout](/images/screenshots/vps-settings-app-packages.png)

### Create a package

1. Click **New Package**
2. Give it a name — e.g. "AI Starter Stack", "Automation Pro"
3. Choose which apps to include — OpenClaw is automatically provisioned with a Knotie API key for each customer
4. Set your customer price (shown in their whitelabel portal)
5. Toggle visibility per plan (show on Cloud VPS 20+ but not VPS 10, for example)
6. Click **Save**
