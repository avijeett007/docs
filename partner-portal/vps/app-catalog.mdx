...
> **Note:** The App Packages section was previously documented as being in VPS Settings, but may not be visible in the current UI. If you do not see it, the feature may have moved or be behind a plan/flag gate.

In **VPS Settings**, look for **App Packages** to create pre-configured bundles you can offer customers as a single product.
