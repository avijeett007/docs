...
![VPS Servers — plan selection cards with pricing and specs](/images/screenshots/vps-servers-main-annotated.png)
...
![VPS instance list with Reinstall button visible](/images/screenshots/vps-instances-reinstall.png)
...
![App Packages section in VPS Settings — name, apps, price, visibility per plan](/images/screenshots/vps-settings-app-packages-annotated.png)
