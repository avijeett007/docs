...
![Customer Portal — API Keys page (Chess Classics whitelabel portal at dashboard.viddescriptor.com/whitelabel/settings/api-keys) showing partner-branded buttons and the dark-themed layout. The page is reached via Customers → Preview for any customer with portal access.](/images/screenshots/customer-api-keys-branded.png)
