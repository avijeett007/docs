...
![Knotie Credits dashboard — current balance, Telephony balance, Auto-recharge status, Quick Buy Credits CTA, and Storage widget in the right rail. Same screenshot is reused by `/partner/telephony-credits` as that page's opening dashboard — the dashboards share the same Account Overview panel.](/images/screenshots/screenshot-2026-03-19-202127.png)

![Credits transaction history — list of recent credit purchases, deductions, and adjustments. The same image is reused as Telephony Credits → Usage Breakdown on `/partner/telephony-credits`; both views share the transaction-list component.](/images/screenshots/screenshot-2026-03-19-202243.png)