...
5. **Job queued** – Deployment added to the platform manager service queue
...
- Job sent to the platform manager service
...
The platform manager service processes the job:
...
**Possible causes:**
- Platform manager service queue backlog
- Network issues
