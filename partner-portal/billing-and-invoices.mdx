...
In the Partner Portal sidebar, open **Billing & Invoices**. The page opens straight to your list of invoices.
...
Invoices move through different statuses, such as:
...
![Billing and Invoices overview with Paid Invoices, This Month, Total Invoices, and Payment Rate metric cards, plus the invoices list and Recurring Invoices and Cancellation Requests sections](/images/screenshots/billing-overview-2026-07-03.png)

![Select Customer modal for creating an invoice, listing customers to choose from with a Cancel button](/images/screenshots/invoice-select-customer-2026-07-03.png)