...
{/* Screenshot needed: Subscription Plans list page — Active toggle and "Display on Landing Page" checkbox per plan */}
...
{/* Screenshot needed: Create/Edit Subscription Plan form — Name, Price, Billing Interval, Display on Landing Page */}
...
{/* Screenshot needed: Whitelabel onboarding Step 9 — plan selection screen with active subscription plans */}
