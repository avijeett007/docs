...
<Note>
There is **no** top-level **Settings → Subscription Plans** entry. Earlier versions of this doc instructed users to "scroll to the Subscription Plans section" of the main Settings page — that section doesn't exist on the new Settings IA. Subscription Plans now lives in the Whitelabel Settings page under the **Subscription Plans** section in the Section Nav Rail.
</Note>
