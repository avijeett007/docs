...
### Keep email access safe

Use a dedicated email account for portal messages and do not reuse its password elsewhere. Follow your email provider's recommended secure connection settings and sending limits.

The setup form includes a required confirmation before custom SMTP can be enabled.
...
![Email Settings section in Partner Settings — Domain Email Service shown as Active (with the irreversible-operation warning), Custom SMTP Server shown as Inactive and disabled because Domain Email Service is active, plus the Stripe Connect panel below](/images/screenshots/email-settings-2026-07-03.png)

![SMTP Settings modal with Use Custom SMTP Server toggle and warning that email features will not be available without proper SMTP setup](/images/Screenshot2025-12-26at1.02.51AM.png)

![SMTP Settings modal with Use Custom SMTP Server enabled and host, port, username, password, from email, and from name fields](/images/Screenshot2025-12-26at1.03.08AM.png)
