...
![Tool Call Quota tab for a customer (KnoLabs AI Agency example) showing Current Usage progress at 0/100 calls on the Basic plan with a 15-minute reset window, Current Plan Details (Plan, Monthly Cost, Quota Limit, Reset Window, Features list), and an Upgrade Quota Plan button](/images/screenshots/screenshot-2026-03-19-163507.png)
