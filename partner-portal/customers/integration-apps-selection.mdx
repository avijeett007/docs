...
> 📷 **Screenshot needed:** _Add a screenshot of the app selection modal showing the **AI & Media** category with ElevenLabs and HeyGen listed._
...
> 📷 **Screenshot needed:** _Add a screenshot of the ElevenLabs API-key connection flow in the customer portal Integration section._

> 🎬 **Video walkthrough:** _Record a short clip showing how to connect ElevenLabs via API key and then confirm its tools appear when building an agent._
