...
5. Configure credit settings:
   - **Enable Notifications** – Toggle whitelabel email alerts on or off
   - **Low Credit Threshold** – Send alerts when balance reaches this amount (in credits remaining)

![Enable AI Credits Toggle](/images/screenshots/customer-ai-credits-toggle-2026-07-03.png)
...
![Add Credits Modal](/images/screenshots/customer-manage-credits-modal-2026-07-03.png)
...
![Credit History Table](/images/screenshots/customer-credit-history-2026-07-03.png)
...
You can also check balances programmatically using the Partner API.
...
![Low Credit Notification Settings](/images/screenshots/customer-ai-credits-toggle-2026-07-03.png)
...
- **Tool calls** – Each integration tool call consumes a small amount of credits
...
- **Document transactions** – Always add notes when adding or deducting credits.
- **Monitor usage patterns** – Use Agent Analytics to spot unusual consumption.
...
- **Credits not deducted during usage** – Verify AI Credits are enabled and your Profit Multiplier is set on the AI Gateway page.
