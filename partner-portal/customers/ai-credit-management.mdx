...
<Warning>
The Features & Add-ons modal does **not** expose **Credit price per minute** or **Grace period** fields, even though earlier versions of this doc listed them. The price is derived from your partner-level **Profit Multiplier** on AI Gateway keys; the grace period (if any) is platform-controlled and not customer-configurable. If you need either, contact Knotie support.
</Warning>
