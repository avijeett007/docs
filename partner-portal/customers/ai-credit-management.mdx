...
<Warning>
The Features & Add-ons modal (last captured 2026-06-05) does **not** expose **Credit price per minute** or **Grace period** fields, even though earlier versions of this doc listed them. The price is derived from your partner-level **Profit Multiplier** on AI Gateway keys; the grace period (if any) is platform-controlled and not customer-configurable. If you need either, contact Knotie support.
</Warning>

![Enable AI Credits Toggle](/images/screenshots/screenshot-2026-03-19-162244.png)
...
![Add Credits Modal](/images/screenshots/screenshot-2026-03-19-201334.png)
...
![Credit History Table](/images/screenshots/screenshot-2026-03-19-163049.png)
...
![Low Credit Notification Settings](/images/screenshots/screenshot-2026-03-19-162244.png)
