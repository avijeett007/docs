...
import { revokeApiKey, renewApiKey } from '@/lib/apiKeys';

export const dynamic = 'force-dynamic'; // Required to make the DELETE request work correctly
...
export async function DELETE(
  ...
  try {
    ...
    // Revoke the API key
    await revokeApiKey(keyId, 'partner');
