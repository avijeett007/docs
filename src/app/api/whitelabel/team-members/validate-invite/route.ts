...
export async function GET(request: NextRequest) {
  try {
    ...
    const customerName = teamMember.customer.firstName && teamMember.customer.lastName
      ? `${teamMember.customer.firstName} ${teamMember.customer.lastName}`
      : teamMember.customer.firstName || teamMember.customer.email;
