...
export default function NewKnowledgeBaseModal({
  isOpen,
  onClose,
  onCreate,
  primaryColor,
}: NewKnowledgeBaseModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-gray-900 rounded-lg w-full max-w-md p-6 relative">
        ...
        <h2 className="text-xl font-semibold text-white mb-4">Create New Knowledge Base</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              style={{ borderColor: primaryColor }}
              placeholder="Add a description for this knowledge base"
            />
          </div>
