...
import { AccentColor, ThemeConfig } from "@/types/theme";
...
export interface PlaygroundProps {
  ...
  onConnect: (connect: boolean, opts?: ConnectOptions) => void;
  onClose: () => void;
}
    ...
    if (voiceAssistant.audioTrack) {
      return (
        <TranscriptionTile
          ...
          accentColor={config.settings.theme_color as AccentColor}
        />
      );
    }
    return null;
