...
4. Pick an **Integration Mode**. The modal currently offers two:
   ...
   - **Knotie Chat Node** — labelled **UPCOMING** (the `custom_node` mode); "Custom N8N node with advanced features". Not yet selectable.
...
<Note>
As of the last walkthrough (2026-06-21), **Proxy Mode is the only enabled integration mode** — Knotie Chat Node shows an **UPCOMING** badge and can't be picked yet. If you need the custom-node integration, check back later or contact Knotie support for availability.
</Note>
