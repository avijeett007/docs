...
| Requirement | Details |
|---|---|
| **Integration gateway** | Your platform must have the integration gateway configured (`CONNECT_HUB_URL` environment variable set). Contact your platform admin if unsure. |
...
1. Knotie AI Pro mints a `scope: all` MCP token for that customer's integration gateway instance.
...
1. Confirm the integration gateway is configured — your platform must have `CONNECT_HUB_URL` set. Check with your admin.
