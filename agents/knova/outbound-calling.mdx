...
ℹ️ _Screenshot to add: the "Assign Agent" modal on the Phone Numbers page, showing a Knova agent selected in the dropdown._
...
ℹ️ _Screenshot to add: the "Test Outbound Call" modal on the Knova Agents page, showing the destination number field and dynamic variables section._
