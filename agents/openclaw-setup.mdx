...
> 📷 **Screenshot needed:** _Add a screenshot of the `/platform/chat` portal UI showing a successful chat response through the OpenClaw channel endpoint._

> 🎬 **Video walkthrough:** _Record a short clip of the end-to-end channel chat flow: sending a message from the portal UI, through the channel endpoint, and receiving an agent reply._
