...
> ![Knotie AI Pro Partner Portal → Phone Numbers list showing imported numbers (captured 2026-06-09 during a GHL warm-lead flow setup; the same screenshot appears in the Retell import and agency command center use cases with different captions — verify the columns against the live page before relying on it for Retell-specific flows)](/images/screenshots/phone-numbers-2026-06-09.png)
...
![Import Phone Numbers modal on step 1 of 4 — provider selection cards for Twilio, Telnyx, Retell, and a locked ElevenLabs (Coming Soon), with a disabled Next button](/images/screenshots/ghl-import-numbers-provider-2026-06-22.png)
...
![Outbound Webhook section in the phone number detail panel — masked owk_ API key with an Active badge, Regenerate Key and Revoke buttons, and a curl usage example posting to connecthub.knotie-ai.pro/api/outbound-call](/images/screenshots/ghl-outbound-webhook-section-2026-06-22.png)
