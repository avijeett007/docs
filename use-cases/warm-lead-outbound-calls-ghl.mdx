...
![Outbound Webhook section in the phone number detail panel with a masked API key, status badge, key controls, and an example request](/images/screenshots/ghl-outbound-webhook-section-2026-06-22.png)
...
- **Action type**: `Webhook`
- **Method**: `POST`
- **URL**: Copy the URL shown in the phone number's **Outbound Webhook** section.

> ℹ️ This configuration lives in the GoHighLevel action panel. Use the URL from the portal so you always have the current endpoint.
