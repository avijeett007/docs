...
The Platform API key creation modal exposes (per the 2026-06-06 audit):
...
<Note>
Live field labels can change without notice — the list above is the verified set as of the last walkthrough. The MCP-related fields (MCP Gateway, Full Access) gate the tool scopes the key can call.
</Note>
