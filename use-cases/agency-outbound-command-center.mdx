...
> 📸 _[Quick onboard customer modal — opens from Customers page top-right]_
...
> 📸 _[Customer Manage modal — Credits tab is one of the 9 tabs in the modal]_
...
> 📸 _[Assign Agent modal — opens from Phone Numbers row, agent dropdown scoped to the customer]_
...
> 📸 _[Outbound key — visible in phone number detail panel after Outbound agent assigned]_
...
> 📸 _[GHL workflow webhook action — see warm-lead-outbound-calls-ghl doc for details]_
