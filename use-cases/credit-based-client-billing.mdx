...
![Features & Add-ons tab showing AI Credit Management toggle and related settings](/images/screenshots/features-addons-ai-credit-management.png)
...
1. In the **Low Credit Notifications** section, toggle **Enable Notifications**
2. Set **Low Credit Threshold** — the balance level that triggers a warning (default is 10 credits)

> The toggle subtext reads: "Send email alerts to customer when credits are low."
...
![Manage Credits modal showing Add/Deduct/Allocate options](/images/screenshots/manage-credits-modal.png)
...
2. In the **Credit Auto-Recharge** section:
   ...
   - Set **Threshold** (minimum 100 credits = $1.00)
   - Set **Amount** (minimum $20)
3. Toggle **Auto-Recharge** on

> The threshold is a "soft floor" — auto-recharge fires whenever a business operation needs more credits than the current balance, even above the threshold.
