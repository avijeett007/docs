...
<Note>
  The live Settings sidebar has 5 sub-items: **Profile Settings, Partner API Keys, Email Domain Management, Plans & Billing, White-Label Portal**. There is no top-level "Security Settings" sub-page — the password, MFA, and passkey controls are grouped under **Profile Settings**.
</Note>
