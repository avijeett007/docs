...
We treat documentation as a living product. All pages are verified against the **live Knotie Partner Portal UI** before being merged.
...
| Feature removed / 404s | Add `<Warning>` or deprecation notice; do not delete without review |
